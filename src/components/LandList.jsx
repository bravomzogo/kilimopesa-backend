...
const OrodhaYaArdhi = () => {
  ...
  useEffect(() => {
    const pataArdhi = async () => {
      try {
        const response = await axios.get('https://nyangi-market.onrender.com/api/land/' && 'http://127.0.0.1:8000/api/land/');
            ...
            {ardhiZilizochaguliwa.map(ardhi => (
              ...
              >
                ...
                <div className="relative group">
                  {ardhi.image && (
                    <img
                      src={`https://nyangi-market.onrender.com${ardhi.image}` && `http://127.0.0.1:8000/${ardhi.image}`}
                      alt={ardhi.title}
        ...
        {selectedArdhi && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl max-w-lg w-full max-h-[80vh] overflow-y-auto p-6 relative">
              ...
              {selectedArdhi.image && (
                <img
                  src={`https://nyangi-market.onrender.com${selectedArdhi.image}` && `http://127.0.0.1:8000/${selectedArdhi.image}`}
